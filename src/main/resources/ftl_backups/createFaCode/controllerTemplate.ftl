package com.walker.controller.${packageName}.${objectNameLower};
...
import com.walker.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.walker.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
