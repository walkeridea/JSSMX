package com.walker.controller.info.pictures;
...
import com.walker.entity.Page;
import com.walker.util.AppUtil;
import com.walker.util.DateUtil;
import com.walker.util.DelAllFile;
import com.walker.util.FileUpload;
import com.walker.util.GetWeb;
import com.walker.util.Jurisdiction;
import com.walker.util.Const;
import com.walker.util.PageData;
import com.walker.util.PathUtil;
import com.walker.util.Tools;
import com.walker.util.Watermark;
import com.walker.service.info.pictures.PicturesManager;
...
public class PicturesController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("info/pictures/pictures_list");
	...
	public ModelAndView listfortc(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = picturesService.list(page);	//列出Pictures列表
		mv.setViewName("info/pictures/pictures_list_tc");
		mv.addObject("varList", varList);
		mv.addObject("pd", pd);
		mv.addObject("QX",Jurisdiction.getHC());	//按钮权限
		return mv;
	...
	public ModelAndView goAdd() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
		mv.setViewName("info/pictures/pictures_add");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goEdit() throws Exception{
		...
		mv.setViewName("info/pictures/pictures_edit");
	...
	public ModelAndView goImageCrawler() throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("info/pictures/imageCrawler");
		return mv;
	}
