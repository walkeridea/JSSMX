package com.walker.controller.info.attached;
...
import com.walker.service.info.attached.AttachedManager;
import com.walker.service.info.attachedmx.AttachedMxManager;
...
public class AttachedController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("info/attached/attached_list");
	...
	public ModelAndView goAdd()throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
		mv.setViewName("info/attached/attached_edit");
