...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			sb.append("var toPageValue = document.getElementById(\"toGoPage\").value;");
			sb.append("if(toPageValue == ''){document.getElementById(\"toGoPage\").value=1;return;}");
			sb.append("if(isNaN(Number(toPageValue))){document.getElementById(\"toGoPage\").value=1;return;}");
			sb.append("nextPage(toPageValue);");
			sb.append("}\n");
			sb.append("</script>\n");
		}
		pageStr = sb.toString();
