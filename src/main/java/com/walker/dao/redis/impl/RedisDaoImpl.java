package com.walker.dao.redis.impl;
...
import com.walker.dao.AbstractBaseRedisDao;
import com.walker.dao.redis.RedisDao;
import com.walker.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.walker.dao.redis.RedisDao#delete(java.lang.String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.walker.dao.redis.RedisDao#delete(java.util.List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.walker.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.walker.dao.redis.RedisDao#get(java.lang.String)
	 */
	@Override
